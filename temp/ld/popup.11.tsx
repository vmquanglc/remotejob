...
export const DeleteTopicPopup = ({ data, onClose, onSubmitDone }) => {
...
const CreateRootTopic = (onSubmitDone, onClose,id) => {
...
const UpdateRootTopic = (onSubmitDone, onClose,id) => {
    const formik = useFormik({
        initialValues: {
            name: "",
            description: "",
...
const CreateTopic = (onSubmitDone, onClose,id) => {
    const formik = useFormik({
        initialValues: {
            name: "",
            description: "",
...
const UpdateTopic = (onSubmitDone, onClose,id,topicList) => {
    const formik = useFormik({
        initialValues: {
            name: "",
            description: "",
    ...
    const configSetup = useCallback((type) => {
        switch (type) {
            case 'CreateRootTopic':
                return CreateRootTopic(onSubmitDone, onClose,id)
                break;
            case 'UpdateRootTopic':
                return UpdateRootTopic(onSubmitDone, onClose,id)
                break;
            case 'CreateTopic':
                return CreateTopic(onSubmitDone, onClose,id)
                break;
        }
    }, [])
