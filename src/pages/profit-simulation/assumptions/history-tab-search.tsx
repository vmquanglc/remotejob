...
const SearchVersion = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
...
const SearchCreateBy = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
			searchByValue: searchByValue,
		},
...
const SearchBy = ({ searchType, onSubmit, searchByValue }) => {
	...
	switch (searchType) {
		case "name":
			component = <SearchVersion {...customProps} />;
			break;
		case "created_by":
			component = <SearchCreateBy {...customProps} />;
			break;
		default:
...
export const HistoryTabSearch = ({ onSearch, valuesSearch, onExport, selectedRows }) => {
	...
	const searchByOptions = [
		{ label: "Version", value: "name", status: false },
		{ label: "Create by", value: "created_by", status: false },
	];
	...
	const handleOnSubmit = (values: any) => {
		...
		if (["name", "created_by"].includes(searchType) && isEmpty(values.searchByValue)) {
