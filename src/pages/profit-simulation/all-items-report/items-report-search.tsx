...
const SearchAsin = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
			searchByValue: searchByValue ?? "",
		},
...
export const ItemsReportSearch = ({ onSearch, valuesSearch, selectedRows }) => {
	...
	const searchByOptions = [{ label: "Product Name", value: "productName", status: false }];
	...
	const handleOnSubmit = (values: any) => {
		...
		if (["productName"].includes(searchType) && isEmpty(values.searchByValue)) {
