...
import { getAddProduct } from "src/services/product-info/add.product.services";
import { useQuery } from "react-query";
import HoverText from "src/components/hover-text";

export const AddProductsTab = () => {
	...
	const { data } = useQuery([`get-list-assign-product`], () => getAddProduct(), {
