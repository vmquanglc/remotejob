...
const SearchPreviewTicket = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
...
const SearchBy = ({ searchType, onSubmit, searchByValue }) => {
	...
	switch (searchType) {
		case "ticket":
			component = <SearchPreviewTicket {...customProps} />;
			break;
		case "email":
...
export const PreviewSearch = ({ onSearch, valuesSearch }) => {
	const [searchType, setSearchType] = useState<string>("ticket");
	...
	const searchByOptions = [
		{ label: "Preview ticket", value: "ticket", status: false },
	...
	const handleOnSubmit = (values: any) => {
		...
		if (["ticket", "email"].includes(searchType) && isEmpty(values.searchByValue)) {
