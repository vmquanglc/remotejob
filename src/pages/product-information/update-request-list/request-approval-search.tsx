...
const SearchEmailManager = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
			searchByValue: searchByValue,
		},
...
const SearchBy = ({ searchType, onSubmit, searchByValue }) => {
	...
	switch (searchType) {
		...
		case "email":
			...
			break;
		case "email_manager":
			component = <SearchEmailManager {...customProps} />;
			break;
		default:
...
export const RequestApprovalTabSearch = ({
	onSearch,
	valuesSearch,
	role,
	selectedRows,
	...
	const searchByOptions = [
		{ label: "Request", value: "name", status: false },
		{ label: "Sales", value: "email", status: false },
		{ label: "Manager", value: "email_manager", status: false },
	];
	...
	const handleOnSubmit = (values: any) => {
		...
		if (["name", "email"].includes(searchType) && isEmpty(values.searchByValue)) {
				...
				<>
					<Grid item>
						<Button
							...
							onClick={() =>
								activities?.hasOwnProperty("pi_many_request_approve_decline") && onApproved()
							}
						>
							Approve
						</Button>
					...
					<Grid item>
						<Button
							...
							onClick={() =>
								activities?.hasOwnProperty("pi_many_request_approve_decline") && onDecline()
							}
						>
							Decline
						</Button>
