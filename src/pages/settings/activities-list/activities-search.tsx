...
const SearchActivity = ({ onSubmit, searchByValue }) => {
	const formik = useFormik({
		initialValues: {
...
const SearchBy = ({ searchType, onSubmit, searchByValue }) => {
	...
	switch (searchType) {
		case "activity":
			component = <SearchActivity {...customProps} />;
			break;
		default:
...
export const ActivitiesSearch = ({ onSearch, valuesSearch }) => {
	...
	const searchByOptions = [{ label: "Activity", value: "activity", status: false }];
	...
	const handleOnSubmit = (values: any) => {
		...
		if (["activity"].includes(searchType) && isEmpty(values.searchByValue)) {
